...
public class MachineListServices extends AsyncTask<Void, Void, String> {

	private Activity mContext;

	private MachineListListener callback;
	private String limit;
	private ProgressDialog progressBar;

	public MachineListServices(Fragment frag, String limit, Activity mContext) {
		// TODO Auto-generated constructor stub

		this.mContext = mContext;

		this.callback = (MachineListListener) frag;
		this.limit = limit;
	}
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_machine_list");
	...
	protected void onPostExecute(String requestMessage) {
		...
		progressBar.dismiss();
		try {
			callback.getAllMachineListResponse(requestMessage);
		} catch (Exception e) {
			// TODO: handle exception
		}
	}
