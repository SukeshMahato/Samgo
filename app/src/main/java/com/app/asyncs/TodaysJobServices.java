...
public class TodaysJobServices extends AsyncTask<Void, Void, String> {

	private Activity mContext;
	private TodayJobsListener callback;
	private String engineerId;
	private ProgressDialog progressBar;

	public TodaysJobServices(Fragment frag, String engineerId, Activity mContext) {
		// TODO Auto-generated constructor stub

		this.mContext = mContext;
		this.callback = (TodayJobsListener) frag;
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_todays_job");
