...
public class ParkJobSyncServices extends AsyncTask<Void, Void, String> {

	private ProgressDialog progressBar;

	private ParkJobSyncListner callback;
	...
	public ParkJobSyncServices(Activity activity, String data, String jobDetailData, String docketDetailData,
		...
		this.callback = (ParkJobSyncListner) frag;
	}
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_sync_park_job");

			List<NameValuePair> profileData = new ArrayList<NameValuePair>();
			profileData.add(new BasicNameValuePair("sync_park", data));
	...
	protected void onPostExecute(String result) {
		...
		progressBar.dismiss();
		try {
			callback.getParkSyncSuccess(result);
		} catch (Exception e) {
			// TODO: handle exception
		}
	}
