...
public class ErrorCodeListServices extends AsyncTask<Void, Void, String> {

	private Activity mContext;

	private ErrorCodeListListener callback;
	private ProgressDialog progressBar;

	public ErrorCodeListServices(Fragment frag, Activity mContext) {
...
//	}
	...
	protected String doInBackground(Void... params) {
		...
		try {
			...
			URL url = new URL(Config.base_url + "engservices/eng_get_machine_error_code_list");
