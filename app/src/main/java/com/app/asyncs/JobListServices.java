...
public class JobListServices extends AsyncTask<Void, Void, String> {

	private Activity mContext;

	private JobsListListener callback;
	private String engineerId;
	private ProgressDialog progressBar;

	public JobListServices(Fragment frag, String engineerId, Activity mContext) {
		// TODO Auto-generated constructor stub

		this.mContext = mContext;

		this.callback = (JobsListListener) frag;
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_job_list");
	...
	protected void onPostExecute(String RequestMessage) {
		...
		try {
			callback.getAllJobListResponse(RequestMessage);
