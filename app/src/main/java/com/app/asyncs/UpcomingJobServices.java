...
public class UpcomingJobServices extends AsyncTask<Void, Void, String> {

	private Activity mContext;

	private UpcomingJobsListener callback;
	private String engineerId;
	private ProgressDialog progressBar;

	public UpcomingJobServices(Fragment frag, String engineerId, Activity mContext) {
		// TODO Auto-generated constructor stub

		this.mContext = mContext;

		this.callback = (UpcomingJobsListener) frag;
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_upcoming_jobs");
	...
	protected void onPostExecute(String RequestMessage) {
		...
		progressBar.dismiss();
		try {
			callback.getUpcomingJobResponse(RequestMessage);
		} catch (Exception e) {
			// TODO: handle exception
		}
	}
