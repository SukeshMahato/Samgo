...
import com.app.listners.JobsDetailsListener;
...
public class JobDetailsServices extends AsyncTask<Void, Void, String> {
	...
	private JobsDetailsListener callback;

	public JobDetailsServices(Activity mContext, String jobId) {
		// TODO Auto-generated constructor stub

		this.mContext = mContext;
		this.job_id = jobId;

		this.callback = (JobsDetailsListener) mContext;
	}
	...
	protected String doInBackground(Void... params) {
		...
		String response = "";
		try {
			URL url = new URL(Config.base_url + "engservices/eng_job_details");

			List<NameValuePair> loginData = new ArrayList<NameValuePair>();
			loginData.add(new BasicNameValuePair("job_id", job_id));
