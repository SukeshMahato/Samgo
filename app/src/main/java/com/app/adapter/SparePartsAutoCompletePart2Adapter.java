...
public class SparePartsAutoCompletePart2Adapter extends ArrayAdapter<MasterSpareParts> {

	final String TAG = "SparePartsAutoCompletePart2Adapter.java";

	Context mContext;
	int layoutResourceId;
	MasterSpareParts data[] = null;

	public SparePartsAutoCompletePart2Adapter(Context mContext, int layoutResourceId, MasterSpareParts[] data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (convertView == null) {
				// inflate the layout
				LayoutInflater inflater = ((CreateDocketActivityPart3) mContext).getLayoutInflater();
